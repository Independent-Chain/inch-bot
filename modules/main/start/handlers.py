    ...
    strings: dict[str, dict] = {
        "greeting": {
            "ru": ( f"Добро пожаловать в <b>inch Community</b> 🌟 Мы хотим сделать мир блокчейн-технологий открытым и доступным для всех."
                    f"\n\n"
                    f"Запустите процесс добычи прямо сейчас. В награду вы будете получать поинты <b>$tINCH</b>, который можно будет <u>обменять на наши жетоны</u> в сети <b>TON</b>. Приглашайте друзей и получайте бонус в размере 100 поинтов ☘️ Чем больше друзей - тем больше наше сообщество."
                    f"\n\n"
            ...
            "en": ( f"Welcome to the <b>inch Community</b> 🌟 We want to make the world of blockchain technology open and accessible to everyone."  
                    f"\n\n"
                    f"Start the mining process right now. In the future, you will receive <b>$tINCH</b> points, which can be <u>exchanged for our jettons</u> in the <b>TON</b> network. Invite friends and receive a community bonus of 100 points ☘️ The more friends, the larger our community."
                    f"\n\n"
